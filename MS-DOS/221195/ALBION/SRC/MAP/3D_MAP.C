...
M3_ModInit(void)
{
	...
	SOUND_Initialize_located_effects(12 * Map_square_size);

	/* Set NPC reaction radius */
	NPC_reaction_radius = (I3DM.Square_size * 3) / 2;
...
Render_3D_map(void)
{
	...
	struct Wall_3D *Wall_ptrs[MAX_3D_WALLS];
	UNSHORT Err;
	UNSHORT i;
	UNBYTE *Ptr;
