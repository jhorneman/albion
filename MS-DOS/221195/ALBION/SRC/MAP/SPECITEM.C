...
Init_compass(void)
{
	...
	Compass_OPM_handle = MEM_Do_allocate
	(
		30 * 29,
		(UNLONG) &Compass_OPM,
		&ROPM_ftype
...
Init_clock(void)
{
	...
	Clock_OPM_handle = MEM_Do_allocate
	(
		32 * 25,
		(UNLONG) &Clock_OPM,
		&ROPM_ftype
...
Update_compass(void)
{
	...
	(
		&Compass_OPM,
		Compass_bit_coordinates[Index][0],
		Compass_bit_coordinates[Index][1],
		6,
		6,
		&Compass_bit[0] + Compass_bit_frame * 36
	);
