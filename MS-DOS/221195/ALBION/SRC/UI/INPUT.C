...
UNLONG Left_Input_object(struct Object *Object, union Method_parms *P);
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Left_Input_object
 * FUNCTION  : Left mouse button method of Input object.
 * FILE      : INPUT.C
 * AUTHOR    : Jurie Horneman
 * FIRST     : 05.10.95 20:48
 * LAST      : 05.10.95 20:48
 * INPUTS    : struct Object *Object - Pointer to object.
 *             union Method_parms *P - Method parameters.
 * RESULT    : UNLONG : 0.
...
UNLONG
Left_Input_object(struct Object *Object, union Method_parms *P)
{
	/* Dehighlight */
	Dehighlight(Object, NULL);
