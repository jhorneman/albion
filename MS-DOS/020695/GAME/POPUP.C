...
static struct Method PUM_methods[] = {
	...
	{ EXIT_METHOD, Exit_PUM_object },
	{ DRAW_METHOD, Draw_PUM_object },
	{ UPDATE_METHOD, Update_help_line },
	{ RIGHT_METHOD, Close_PUM_object },
	{ CLOSE_METHOD, Close_PUM_object },
...
Do_PUM(SISHORT X, SISHORT Y, struct PUM *Data)
{
	...
	struct PUME *PUMES;
	UNSHORT Width, Height, PUM_object;
	UNSHORT Count, W;
	UNSHORT i;
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Exit_PUM_object
 * FUNCTION  : Exit method of PUM object.
 * FILE      : POPUP.C
 * AUTHOR    : Jurie Horneman
 * FIRST     : 19.10.94 14:50
 * LAST      : 19.10.94 14:50
...
void
Exit_PUM_object(struct Object *Object, union Method_parms *P)
{
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Close_PUM_object
 * FUNCTION  : Close method of PUM object.
 * FILE      : POPUP.C
 * AUTHOR    : Jurie Horneman
 * FIRST     : 20.10.94 15:26
 * LAST      : 20.10.94 15:26
 * INPUTS    : struct Object *Object - Pointer to object.
 *             union Method_parms *P - Method parameters.
 * RESULT    : None.
...
void
Close_PUM_object(struct Object *Object, union Method_parms *P)
{
