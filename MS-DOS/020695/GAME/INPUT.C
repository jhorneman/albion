...
/* Input variables */
struct PA Input_PA;
BOOLEAN Input_aborted;
UNSHORT Max_input_length, Current_input_length;
UNSHORT Input_object;
UNSHORT Cursor_X;
UNCHAR Input_buffer[200];
...
static struct Method BooleanReq_methods[] = {
	...
	{ EXIT_METHOD, Exit_BooleanReq_object },
...
static struct Method MemberSel_methods[] = {
	...
	{ EXIT_METHOD, Exit_MemberSel_object },
	{ DRAW_METHOD, Draw_MemberSel_object },
	{ UPDATE_METHOD, Update_help_line },
	{ RIGHT_METHOD, Close_MemberSel_object },
	{ CLOSE_METHOD, Close_MemberSel_object },
	{ TOUCHED_METHOD, Dehighlight },
	{ RESTORE_METHOD, Restore_window },
	{ 0, NULL}
};
...
static struct Method ItemSel_methods[] = {
	...
	{ EXIT_METHOD, Exit_ItemSel_object },
	{ DRAW_METHOD, Draw_ItemSel_object },
	{ UPDATE_METHOD, Update_help_line },
	{ RIGHT_METHOD, Close_ItemSel_object },
	{ CLOSE_METHOD, Close_ItemSel_object },
	{ TOUCHED_METHOD, Dehighlight },
	{ RESTORE_METHOD, Restore_window },
	{ 0, NULL}
};
...
struct Object_class SelItem_slot_Class = {
...
Init_BooleanReq_object(struct Object *Object, union Method_parms *P)
{
	...
	BooleanReq->Text = OID->Text;

	/* Prepare window */
	Prepare_window((struct Window_object *) Object);

	/* Set root OPM */
	Set_root_OPM(&(BooleanReq->Window_OPM));

	/* Install mouse area */
	Push_MA(&(Object->Rect));

	/* Initialize button data */
	BooleanReq_YES_button_data.Text_button_data.Text = System_text_ptrs[60];
	BooleanReq_NO_button_data.Text_button_data.Text = System_text_ptrs[61];

	/* Add buttons to window */
 	Add_object(Object->Self, &Button_Class, (UNBYTE *) &BooleanReq_YES_button_OID,
	 45, 50, 50, 11);
 	Add_object(Object->Self, &Button_Class, (UNBYTE *) &BooleanReq_NO_button_OID,
	 105, 50, 50, 11);
}
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Exit_BooleanReq_object
 * FUNCTION  : Exit method of Boolean requester window object.
 * FILE      : INPUT.C
 * AUTHOR    : Jurie Horneman
...
void
Exit_BooleanReq_object(struct Object *Object, union Method_parms *P)
{
	Destroy_window((struct Window_object *) Object);
	Pop_MA();
...
Draw_BooleanReq_object(struct Object *Object, union Method_parms *P)
{
	...
	if (BooleanReq->Text)
	{
		...
		Push_PA(&PA);
		Set_ink(SILVER_TEXT);
		Display_text(OPM, BooleanReq->Text);
		Pop_PA();
	}
...
Init_MemberSel_object(struct Object *Object, union Method_parms *P)
{
	...
	/* Set root OPM */
	Set_root_OPM(&(MemberSel_window->Window_OPM));
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Exit_MemberSel_object
 * FUNCTION  : Exit method of Member selection window object.
 * FILE      : INPUT.C
 * AUTHOR    : Jurie Horneman
...
void
Exit_MemberSel_object(struct Object *Object, union Method_parms *P)
{
	Destroy_window((struct Window_object *) Object);
	Pop_MA();
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Close_MemberSel_object
 * FUNCTION  : Close method of Member selection window object.
 * FILE      : INPUT.C
 * AUTHOR    : Jurie Horneman
 * FIRST     : 06.04.95 13:02
 * LAST      : 06.04.95 13:02
 * INPUTS    : struct Object *Object - Pointer to object.
 *             union Method_parms *P - Method parameters.
 * RESULT    : None.
...
void
Close_MemberSel_object(struct Object *Object, union Method_parms *P)
{
...
Init_ItemSel_object(struct Object *Object, union Method_parms *P)
{
	...
	/* Set root OPM */
	Set_root_OPM(&(ItemSel_window->Window_OPM));
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Exit_ItemSel_object
 * FUNCTION  : Exit method of Item selection window object.
 * FILE      : INPUT.C
 * AUTHOR    : Jurie Horneman
...
void
Exit_ItemSel_object(struct Object *Object, union Method_parms *P)
{
	Destroy_window((struct Window_object *) Object);
	Pop_MA();
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Close_ItemSel_object
 * FUNCTION  : Close method of Item selection window object.
 * FILE      : INPUT.C
 * AUTHOR    : Jurie Horneman
...
void
Close_ItemSel_object(struct Object *Object, union Method_parms *P)
{
	Dehighlight(Object, NULL);
	Delete_object(Object->Self);
}
