...
Default_decider(struct Combat_participant *Part)
{
	...
	Global_danger = 100 - ((Remaining_monsters * 100) / Nr_monsters);
...
Rinrii_decider(struct Combat_participant *Part)
{
	...
	if (Nr_monsters == Remaining_monsters)
	{
		/* Yes -> Attack */
		return TRUE;
	}
...
Kritha_decider(struct Combat_participant *Part)
{
	...
	if (Remaining_monsters >= Remaining_members)
	{
 ...
 struct Combat_participant *Defender_part)
{
	...
	if (Probe(10, 100))
	{
		...
		/* Tell the player */
		Print_part_message(Defender_part, 737);
	}
}
	...
	if (Probe(10, 100))
	{
		...
		switch (rand() % 2)
		{
			...
			case 1:
			{
				...
				/* Tell the player */
				Print_part_message(Defender_part, 738);
				break;
			}
		}
	}
	...
	if (Probe(10, 100))
	{
		...
		switch (rand() % 3)
		{
			case 0:
			{
				...
				/* Tell the player */
				Print_part_message(Defender_part, 739);
				break;
			}
			case 1:
			{
				...
				/* Tell the player */
				Print_part_message(Defender_part, 740);
				break;
			}
			case 2:
			{
