...
Attribute_value_getter(SILONG *Value_ptr, SILONG *Maximum_ptr, UNSHORT Value_index)
{
	...
	*Value_ptr		= (SILONG) Char->Attributes[Value_index].Normal;
	*Maximum_ptr	= (SILONG) Char->Attributes[Value_index].Maximum;
...
Skill_value_getter(SILONG *Value_ptr, SILONG *Maximum_ptr, UNSHORT Value_index)
{
	...
	*Value_ptr		= (SILONG) Char->Skills[Value_index].Normal;
	*Maximum_ptr	= (SILONG) Char->Skills[Value_index].Maximum;
