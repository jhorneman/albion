...
void
Do_C1_Spell_9(struct Combat_participant *Victim_part, UNSHORT Tactical_X,
...
C1_Spell_9_handler(UNSHORT Strength)
{
	...
	/* "Do" spell for each target */
	Do_all_magic_combat_targets( Strength, Do_C1_Spell_9);
...
//	Do_C2_Spell_11(Victim_part, Tactical_X, Tactical_Y, Strength);
//	return;
