...
Draw_Button_object(struct Object *Object, union Method_parms *P)
{
	...
	{
		/* No -> Clear button area */
		Restore_background(Object->Rect.left - 1, Object->Rect.top - 1,
		 Object->Rect.width + 2, Object->Rect.height + 2);
		...
		switch (Button->Type & 0x00FF)
		{
			case TEXT_BUTTON_TYPE:
			{
				...
				Draw_deep_border(Current_OPM, Object->X - 1, Object->Y - 1,
				 Object->Rect.width + 2, Object->Rect.height + 2);
				...
				Print_centered_box_string(Current_OPM, Object->X, Object->Y + 1,
			...
			case SYMBOL_BUTTON_TYPE:
			{
				...
				/* Display symbol */
				Put_masked_block(Current_OPM, Object->X + dX, Object->Y + dY,
				 W, H, Ptr);
			...
			case DOUBLE_SYMBOL_BUTTON_TYPE:
			{
				...
				/* Display symbol */
				Put_masked_block(Current_OPM, Object->X, Object->Y, W, H, Ptr);
...
Feedback_Button_object(struct Object *Object, union Method_parms *P)
{
	...
	switch (Button->Type & 0x00FF)
	{
		case TEXT_BUTTON_TYPE:
		{
			...
			Print_centered_box_string(Current_OPM, Object->X, Object->Y + 2,
			 Object->Rect.width, Object->Rect.height,
			 Button->Data->Text_button_data.Text);
		...
		case SYMBOL_BUTTON_TYPE:
		{
			...
			/* Display symbol */
			Put_masked_block(Current_OPM, Object->X + dX, Object->Y + dY + 1,
			 W, H, Ptr);
	...
	if (Button->State)
	{
		...
		switch (Button->Type & 0x00FF)
		{
			case TEXT_BUTTON_TYPE:
			{
				...
				Draw_deep_border(Current_OPM, Object->X - 1, Object->Y - 1,
				 Object->Rect.width + 2, Object->Rect.height + 2);
				Draw_deep_border(Current_OPM, Object->X, Object->Y,
				 Object->Rect.width, Object->Rect.height);
				Put_recoloured_box(Current_OPM, Object->X + 1, Object->Y + 1,
				 Object->Rect.width - 2, Object->Rect.height - 2, &(Recolour_tables[6][0]));
			...
			case DOUBLE_SYMBOL_BUTTON_TYPE:
			{
				...
				Put_recoloured_box(Current_OPM, Object->X, Object->Y,
				 Object->Rect.width, Object->Rect.height, &(Recolour_tables[6][0]));
	...
	else
	{
		...
		switch (Button->Type & 0x00FF)
		{
			case TEXT_BUTTON_TYPE:
			{
				...
				Draw_deep_border(Current_OPM, Object->X - 1, Object->Y - 1,
				 Object->Rect.width + 2, Object->Rect.height + 2);
				Draw_light_box(Current_OPM, Object->X, Object->Y, Object->Rect.width,
				 Object->Rect.height);
