...
Init_BooleanReq_object(struct Object *Object, union Method_parms *P)
{
	...
	/* Add buttons to window */
	 ...
	 (UNBYTE *) &BooleanReq_YES_button_OID, 25, 50,
	 BOOLEANREQ_BUTTON_WIDTH, 11);
 	Add_object(Object->Self, &Button_Class,
	 (UNBYTE *) &BooleanReq_NO_button_OID, BOOLEANREQ_WIDTH - 25 -
	 BOOLEANREQ_BUTTON_WIDTH, 50, BOOLEANREQ_BUTTON_WIDTH, 11);
