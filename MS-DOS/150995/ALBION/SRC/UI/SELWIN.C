 ...
 UNSHORT Entry_height, UNBYTE *Data)
{
	...
	for (i=0;i<Nr_entries;i++)
	{
		...
		{
			/* Yes -> Evaluate entry */
			Blocked_message_nrs[i] = (Evaluator)(i, Data);
	...
	if (Counter)
	{
		...
		Select_window_object = Add_object(0, &Select_window_Class,
...
Init_Select_window_object(struct Object *Object, union Method_parms *P)
{
	...
	if (Select_window->Nr_selectables > MAX_SELECTABLES_IN_WINDOW)
	{
		...
		Change_object_size(Object->Self, Select_window->Selectable_width +
		 27 + BETWEEN + SCROLL_BAR_WIDTH, H);
		...
		/* Add object */
		Select_window->Scroll_bar_object = Add_object(Object->Self,
		 &Scroll_bar_Class, (UNBYTE *) &Scroll_bar_OID,
		 Select_window->Selectable_width + 13 + BETWEEN, 12,
		 SCROLL_BAR_WIDTH, (MAX_SELECTABLES_IN_WINDOW *
	   ...
	   Selectable_OID.Index = 0;
		...
		{
			/* Add object */
			Add_object(Object->Self, &Selectable_Class,
			 (UNBYTE *) &Selectable_OID, 13, Y, Select_window->Selectable_width,
	...
	else
	{
		...
		/* Set width and height */
		Change_object_size(Object->Self, Select_window->Selectable_width + 27,
		 H);
...
Draw_Selectable_object(struct Object *Object, union Method_parms *P)
{
	...
	/* Draw selectable */
	(Select_window->Draw_function)(OPM, Object, Index, Select_window->Data,
...
Left_Selectable_object(struct Object *Object, union Method_parms *P)
{
	...
	if (Normal_clicked(Object))
	{
		...
		if (!Message_nr)
		{
			...
			*(Select_window->Result_ptr) = Index;
