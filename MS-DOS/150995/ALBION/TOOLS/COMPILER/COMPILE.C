 ...
 * RESULT    : None.
 * BUGS      : No known.
 * NOTES     : - This function will set the global variables
 *              Total_nr_subfiles and Highest_subfile_index, and it will fill
 *              the Subfile_path_ptrs array. If a subfile does not exist,
 *              it's entry in this array will be NULL.
 * SEE ALSO  :
 * #FUNCTION HEADER END#
 */
 ...
 UNCHAR *Library_path)
{
	...
	/* Compile library */
	Library_file_length = 8 + (Nr_subfiles * 4);
