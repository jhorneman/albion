...
#define CLOSED_CHEST_PICTURE	(1)
#define OPEN_CHEST_PICTURE		(2)
...
UNSHORT Small_picture_width, Small_picture_height;
...
Closed_chest_ModInit(void)
{
	...
	/* Load small picture */
//	Small_picture_handle = Load_subfile(PICTURE, CLOSED_CHEST_PICTURE);
...
Closed_chest_DisInit(void)
{
	...
	InvLeft_object = Add_object(Earth_object, &Closed_chest_Class, NULL,
...
Open_chest_ModInit(void)
{
	...
	/* Load small picture */
//	Small_picture_handle = Load_subfile(PICTURE, OPEN_CHEST_PICTURE);
...
{
	/* Add interface objects */
	InvLeft_object = Add_object(Earth_object, &Open_chest_Class, NULL,
	 0, 0, INVENTORY_MIDDLE, Panel_Y);
	InvRight_object = Add_object(Earth_object, &InvRight_Class, NULL,
	 INVENTORY_MIDDLE, 0, Screen_width - INVENTORY_MIDDLE, Panel_Y);
