 ...
 union Combat_show_parms *P)
{
	...
	Tactical_icon_nr = PARTY_CHARS_MAX + Char->Monster_graphics_nr;
 ...
 SILONG *Top_3D_ptr, SILONG *Right_3D_ptr, SILONG *Bottom_3D_ptr)
{
	...
	else
	{
		...
		Get_COMOB_rectangle(Part->Main_COMOB, Left_3D_ptr, Top_3D_ptr,
		 Right_3D_ptr, Bottom_3D_ptr);
	}
}
