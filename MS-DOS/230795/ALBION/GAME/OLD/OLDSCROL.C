...
struct Method Scroll_bar_methods[] = {
...
Init_Scroll_bar_object(struct Object *Object, union Method_parms *P)
{
	...
	else
	{
		...
		/* Calculate movement room of slider */
		...
		/* Slider too small ? */
		if (Scroll_bar->Slider_height < MIN_SLIDER_HEIGHT)
		{
			/* Yes -> Set to minimum size */
			Scroll_bar->Slider_height = MIN_SLIDER_HEIGHT;

			/* Adjust movement room of slider */
			Scroll_bar->Max_Y = Object->Rect.height - MIN_SLIDER_HEIGHT;
		}
	}
}
