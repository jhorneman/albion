...
#define BOOLEANREQ_WIDTH			(260)
#define BOOLEANREQ_HEIGHT			(74)

#define BOOLEANREQ_BUTTON_WIDTH	(100)
...
Boolean_requester(UNCHAR *Text)
{
	...
	return(Boolean_requester_with_buttons
	(
		Text,
		System_text_ptrs[60],
		System_text_ptrs[61]
 ...
 UNCHAR *No_button_text)
{
	...
	(
		...
		&BooleanReq_Class,
		(UNBYTE *) &OID,
		(Screen_width - BOOLEANREQ_WIDTH) / 2,
		(Panel_Y - BOOLEANREQ_HEIGHT) / 2,
		BOOLEANREQ_WIDTH,
		BOOLEANREQ_HEIGHT
	);
...
Init_BooleanReq_object(struct Object *Object, union Method_parms *P)
{
	...
	(
		Object->Self,
		&Button_Class,
		(UNBYTE *) &BooleanReq_YES_button_OID,
		25,
		50,
		BOOLEANREQ_BUTTON_WIDTH,
		11
	);
 	Add_object
	(
		Object->Self,
		&Button_Class,
		(UNBYTE *) &BooleanReq_NO_button_OID,
		BOOLEANREQ_WIDTH - 25 - BOOLEANREQ_BUTTON_WIDTH,
		50,
		BOOLEANREQ_BUTTON_WIDTH,
		11
	);
