 ...
 *             BOOLEAN X_mirror_flag - X-mirroring flag.
 * RESULT    : None.
 * BUGS      : No known.
...
Put_zoomed_block(struct OPM *OPM, SISHORT X, SISHORT Y, UNSHORT Source_width,
 ...
 UNBYTE *Graphics_ptr, BOOLEAN X_mirror_flag)
{
	 ...
	 (Target_height > 0))
	{
		 ...
		 X_mirror_flag)
		{
			...
			(
				...
				Target_width,
				Target_height,
				(SILONG) Recolouring_table,
				ZOOMMODE_RECOLOUR_BACK
			);
