...
/* TPB file type */
static UNCHAR TPB_fname[] = "Text processing block";

struct File_type TPB_ftype = {
	MEM_Relocate,
	0xFF,
	0,
	MEM_KILL_ALWAYS,
...
UNCHAR *Text_error_strings[TEXTERR_MAX + 1] = {
