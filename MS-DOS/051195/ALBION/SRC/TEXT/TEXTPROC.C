		...
		for (;;)
		{
			...
			if (Char == COMSTART_CHAR)
			{
				...
				for (i=0;i<4;i++)
				{
					...
					/* Is premature end of command ? */
					if (Char2 == COMEND_CHAR)
					{
						/* Yes -> Report error */
						Text_error(TEXTERR_COMMAND_TOO_SHORT);
