...
//			OPM_Box(&(Scroll_2D.Base_OPM), nX, nY, 16, 8, rand() % 256);
		}
...
//			OPM_Box(&(Scroll_2D.Base_OPM), nX, nY + 8, 16, 8, rand() % 256);
		}
 ...
 ******************************************************************************
 * #FUNCTION HEADER BEGIN#
 * NAME      : Update_map_rectangle
 * FUNCTION  : Update a map area.
 * FILE      : 2D_DISPL.C
 * AUTHOR    : Jurie Horneman
 ...
 *             UNSHORT Height - Height in of area map squares.
 * RESULT    : None.
 * BUGS      : No known.
 * SEE ALSO  :
 * #FUNCTION HEADER END#
...
void
Update_map_area(SISHORT X, SISHORT Y, UNSHORT Width, UNSHORT Height)
{
