...
Dialogue_MainLoop(void)
{
	...
	/* At this point, it is possible that the dialogue has been ended during
	 ...
	 Therefore there should be no logic beyond this point, except for the
	 end of dialogue logic.
	 Because the End_dialogue_flag is cleared in the module exit function,
	 one can be certain this logic will not try to pop a dialogue module
