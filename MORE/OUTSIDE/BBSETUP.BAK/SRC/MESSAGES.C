...
MESSAGES Messages [MAX_LANGUAGES] =
{
	//Deutsch:
	{
		...
		"Bitte Zielpfad wÑhlen:",

		//Bei Fehlern:
		"Laufwerk %c ist schreibgeschÅtzt. Installation wird abgebrochen.",
		"Laufwerk %c ist offen oder leer. Installation wird abgebrochen.",
		...
		"Falls das nicht hilft, kînnen Sie die CD kosten~los bei Blue Byte um~tau~schen. Schicken Sie dazu die CD (bitte nicht Ver~packung oder das Hand~buch) an Blue Byte Software Gmbh, Eppinghofer Str. 150, 45468 MÅlheim an der Ruhr.",
